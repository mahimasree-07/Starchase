...
OBJECTS = star.o asteroid.o game.o main.o termfuncs.o dot.o boulder.o highscore.o
...
highscore.o: highscore.cpp highscore.h constants.h
	$(CXX) $(CXXFLAGS) -c highscore.cpp
	chmod g+rw highscore.o

# Clean up build artifacts
clean:
	rm -f *.o $(TARGET) $(wildcard highscore.dat)
